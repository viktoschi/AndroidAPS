...
public class DanaRStatsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.danar_historystatsactivity);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                for (DanaRHistoryRecord record: historyList) {
                    ...
                    mainView.append(" BR: " + DecimalFormatter.to2Decimal(record.getRecordDailyBasal()));
                    mainView.append(" Bo: " + DecimalFormatter.to2Decimal(record.getRecordDailyBolus()));
                    mainView.append(" TDD: " + DecimalFormatter.to2Decimal(tdd));
